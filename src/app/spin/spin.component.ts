...
export class SpinComponent implements OnInit {
 ...
 showMainContent: boolean;
  ...
  ngOnInit() {
      console.log(this);
    var startSeqs = {};
    console.log('outside the start qus');
    console.log(startSeqs);
    var startNum = 0;
    // jQuery FN
    $.prototype.playSpin = function (options) {
    //   this.showMainContent = !this.showMainContent;
      ...
      console.log(options);
        if (this.length) {
            ...
            console.log('inside the startsqs');
            console.log(startSeqs);
  ...
  //   this.showMainContent = !this.showMainContent;
    ...
    spin() {
        $('#btn-example6').click(function() {
            ...
            var num3 = $('#example6 ul').val();
            (<any>$('#example6 ul')).playSpin({
                endNum: [0 ,2, 3],
            });
            console.log('inside Narendra');
